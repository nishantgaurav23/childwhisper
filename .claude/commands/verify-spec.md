...
9. **If PASS** — Confirm roadmap.md shows "done" for this spec.
10. **If FAIL** — List specific items that need fixing before the spec can be considered done.
