...
- ALWAYS mock external services in tests (model inference, audio I/O, HF Hub)
- ALWAYS ensure audio is 16kHz mono in all processing code
- ALWAYS apply EnglishTextNormalizer to predictions
